...
DEB_COMPLEX_DISTS_PACKAGE_URL = urljoin(DEB_COMPLEX_DISTS_FIXTURE_URL, DEB_PACKAGE_RELPATH)
DEB_COMPLEX_DISTS_GENERIC_CONTENT_URL = urljoin(DEB_COMPLEX_DISTS_FIXTURE_URL, DEB_GENERIC_CONTENT_RELPATH)
